...
#channels = [1, 0, 4]     # 0,1,2 are pins 26-28;  3 is V_ref and 4 is internal thermometer
#kSPS_per_ch = 160 * len(channels)    # note there is only one multiplexed ADC
#
...
ax.plot((-min(read_counter)+np.array(read_counter))*10, lw=.3, c='k') 
