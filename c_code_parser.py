...
def generate_command_binary_interface(proj_path):
...
def generate_report_binary_interface(proj_path):
    C_code = gather_C_code(proj_path)
    command_codes = generate_command_codes(C_code)
...
if __name__ == "__main__":
    ...
    command_functions, markdown_docs = generate_command_binary_interface(proj_path)
    ...
    report_lengths, report_header_signatures, arg_names_for_reports = generate_report_binary_interface(proj_path)
