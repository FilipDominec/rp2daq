...
hw.init_stepper(motor_id=0, dir_pin=12, step_pin=13, endswitch_pin=19, disable_pin=0, motor_inertia=128*4) #, reset_nanopos=0)
...
hw.calibrate_stepper_positions(motor_ids=(3,), minimum_micropos=-10000, nanospeed=256, bailout_micropos=10000 )
